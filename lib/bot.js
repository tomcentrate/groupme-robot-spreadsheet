...
const group_spreadsheets = require('./group_spreadsheets');
class Bot {
    /**
     ...
     * @return {string}
     */
    static checkMessage(message, group_id) {
        ...
        const botRegex = /^\/robot spreadsheet/;
        ...
        if (messageText && botRegex.test(messageText)) {
            ...
            if( group_id in group_spreadsheets) {
              return group_spreadsheets[group_id];
            } else {
              return '¯\\_(ツ)_/¯ Ask your admin about it.';
            }
        }
